package io.quarkiverse.quarkus.reactive.mysql.pool.client.runtime;
...
public class MySQLPoolRecorder {
    ...
    private MySQLPool initialize(Vertx vertx,
        ...
        if (mysqlConnectOptions.size() == 1) {
            return MySQLPool.pool(vertx, mysqlConnectOptions.get(0), poolOptions);
        } else {
