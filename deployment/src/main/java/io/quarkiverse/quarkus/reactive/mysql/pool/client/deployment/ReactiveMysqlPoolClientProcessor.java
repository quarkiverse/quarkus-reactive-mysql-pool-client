...
import io.quarkiverse.quarkus.reactive.mysql.pool.client.runtime.MySQLServiceBindingConverter;
...
class ReactiveMysqlPoolClientProcessor {

    private static final String FEATURE = "reactive-mysql-pool-client";
    ...
    void addHealthCheck(
        ...
        healthChecks.produce(
                new HealthBuildItem(
                        "io.quarkiverse.quarkus.reactive.mysql.pool.client.runtime.health.ReactiveMySQLDataSourcesHealthCheck",
